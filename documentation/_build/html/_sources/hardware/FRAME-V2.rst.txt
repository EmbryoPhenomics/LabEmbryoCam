LabEmbryoCam Frame - V2
================

The LabEmbryoCam V2 frame is constructed using Rexroth branded aluminium extrusion of different profiles and lengths.
2020 extrusion is 20 mm x 20 mm in cross section and 2040 extrusion is 20 mm x 40 mm in cross section, 2020R extrusion has a rounded edge. The LEC uses Rexroth blind connectors - for more information see here: 
The advantage of V2 over V1 is that the aluminimum frame uses blind connectors, whereas V1 relies on 3D printed brackets for holding the extrusion in place.

.. raw:: html

    <iframe src="https://plymouth222.autodesk360.com/shares/public/SH286ddQT78850c0d8a430ff0e4c71d9b965?mode=embed" width="640" height="480" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"  frameborder="0"></iframe>
