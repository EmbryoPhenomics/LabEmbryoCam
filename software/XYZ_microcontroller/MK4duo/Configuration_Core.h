...
#define Z_PROBE_OFFSET_FROM_NOZZLE 0     // Z offset: -below [of the nozzle] (always negative!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78, 78, 185}
/*****************************************************************************************/
...
#define DEFAULT_MAX_FEEDRATE          {200, 200, 300, 100}
...
#define HOMING_FEEDRATE_X (25*60)
#define HOMING_FEEDRATE_Y (25*60)
