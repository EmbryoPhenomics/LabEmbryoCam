...
to the size of a multiwell plate, but could be scaled both up and down. Before aattempting to build the LabEmbryoCam you will need to source everything from
...
The interactive CAD windows allow you to move the model around, zoom in and out, and also strip parts of the model away to see specific details. Try clicking on the full LabEmbryoCam 
CAD model below and moving it around.

During the build process, this should enable you to see precisely where everything should go - all the way down to individual nuts and bolts. Models may take time to load, so be patient. 

**3D printing**

STL files are provided for the 3D printed parts, and we recommend that these are printed using PETG, or even PETG with chopped carbon fibre, with a minimum
...
Filamentive is an excellent manufacturer of recycled PETG and CF-PETG filament.
